...
The `test_interaction()` function can be used to see the results of the regression `y ~ x1 + x2 + x1x2`, the correlation between the variables, and find the simple slopes from the plot above. In this case, the 'lower slope', X2 Group = 1, is roughly 0, while the 'upper slope', X2 Group = 2, is 0.38.
