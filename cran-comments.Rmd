...
This is a resubmission. In this version I have addressed the recommended changes to the package:

* Changed T/F to TRUE/FALSE in Rd.-files
...
* Removed \dontrun{} or replaced with \donttest{}.
* Removed information messages that cannot be suppressed (replaced with message() or warning()).
